...
class Cco < Formula
  ...
  if OS.mac? && Hardware::CPU.arm?
    url "https://github.com/visiquate/cco/releases/download/v2026.2.9/cco-aarch64-apple-darwin.tar.gz"
    sha256 "328d581d764c75716492f2cd0be0c495298b64bea5b527473d1e10a9c983164a"
