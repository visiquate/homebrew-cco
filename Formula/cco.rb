...
class Cco < Formula
  ...
  if OS.mac? && Hardware::CPU.arm?
    url "https://github.com/visiquate/cco/releases/download/v2026.2.8/cco-aarch64-apple-darwin.tar.gz"
    sha256 "bf240db4b5ab379192a196d65fa06947b4a8821b21b37140343aad93dc2e833a"
