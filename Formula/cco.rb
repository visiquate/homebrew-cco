...
class Cco < Formula
  ...
  if OS.mac? && Hardware::CPU.arm?
    url "https://github.com/visiquate/cco/releases/download/v2025.12.58/cco-aarch64-apple-darwin.tar.gz"
    sha256 "bce2bfd1dc6371322a0b06d2f498948325f87732686fbe4825c6e259b285aba2"
