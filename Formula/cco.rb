...
class Cco < Formula
  ...
  if OS.mac? && Hardware::CPU.arm?
    url "https://github.com/visiquate/cco/releases/download/v2026.2.102/cco-aarch64-apple-darwin.tar.gz"
    sha256 "ffa370a285562384390166080d281cdaf4a7de20cdd45fe641508ffe2bc3cdc8"
