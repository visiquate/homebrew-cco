...
class Cco < Formula
  ...
  if OS.mac? && Hardware::CPU.arm?
    url "https://github.com/visiquate/cco/releases/download/v2026.2.56/cco-aarch64-apple-darwin.tar.gz"
    sha256 "644321e37597d2117a4e2d51bbbc2c616749b349201a935af3561074a4c59acc"
