...
class Cco < Formula
  ...
  if OS.mac? && Hardware::CPU.arm?
    url "https://github.com/visiquate/cco/releases/download/v2026.2.12/cco-aarch64-apple-darwin.tar.gz"
    sha256 "92fc52e6ac47bf35d40240f34aeaa8a99634c5efb1f8de039c693d898cd31c6f"
